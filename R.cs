...
using AddOperation = GClass3197;
using ResizeOperation = GClass3208;
using MoveOperation = GClass3203;
using FoldOperation = GClass3220;
using TradingPlayerInteractions = GClass3481;
